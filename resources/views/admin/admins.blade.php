        ...
        <div class="under-burger-btn-cont mr-4 ml-4">
            <div class="container-fluid row m-0 p-0 align-items-center">
                ...
                <div class="col-6 col-md-4 text-right">
                    <a name="" id="" class="btn add-btn" href="{{route('admins.create')}}" role="button">Add Admins</a>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border">
                            ...
                            <a name="" id="" class="btn" href="{{route('admins.destroy',['id'=>$item->id])}}" role="button">Remove</a>
