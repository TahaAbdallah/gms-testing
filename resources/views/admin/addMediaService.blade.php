...
@section('dashboard-title','Add Media Service')
...
@section('content')
        ...
        <div class="under-burger-btn-cont mr-4 ml-4">
            <div class="container-fluid row m-0 p-0 align-items-center">
                ...
                <div class="col-6 col-md-4 text-right">
                    <a name="" id="" class="btn add-btn" href="{{route('mediaServices')}}" role="button">Show All Media Services</a>
                </div>
            </div>
        </div>
        ...
        <form action="{{route('mediaService.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="table-responsive mr-4 ml-4">
            ...
            <div class="col-12 text-center mt-5">
                <button class="btn add-btn" type="submit">Add Media Service</button>
            </div>
