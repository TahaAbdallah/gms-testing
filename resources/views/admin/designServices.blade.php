...
@section('dashboard-title','Design Services')
...
@section('content')
        ...
        <div class="under-burger-btn-cont mr-4 ml-4">
            <div class="container-fluid row m-0 p-0 align-items-center">
                <div class="col-8">
                    <p class="m-0 admins-main-page">SERVICES | Design Services</p>
                </div>
                <div class="col-4 text-right">
                    <a name="" id="" class="btn add-btn" href="{{route('designService.create')}}" role="button">Add a Service</a>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid row our-services-table">
            ...
            <div class="col-md-2">
                ...
                <div class="col-12 row our-services-action-col justify-content-center">
                    <a name="" id="" class="btn add-btn m-2 p-2" href="{{route('designService.destroy',['id'=>$item->id])}}" role="button">Delete Service</a>
                    <a name="" id="" class="btn add-btn m-2 p-2" href="{{route('designServices.edit',['id'=>$item->id])}}" role="button">Edit Service</a>                </div>
