...
<div class="under-burger-btn-cont">
    <div class="container-fluid row m-0 p-0 align-items-center">
        ...
        <div class="col-6 col-md-4 text-right">
            <a name="" id="" class="btn add-btn" href="{{route('managers')}}" role="button">Show All Managers</a>
        </div>
    </div>
</div>
    ...
    <div class="table-responsive">
        ...
        <table class="table data-table border">
            ...
            <tbody>
                ...
                <tr>
                    <td scope="row" class="border"><input type="text" name="name" placeholder="Manager Name"></td>
                    <td scope="row" class="border"><input type="text" name="email" placeholder="Manager Email"></td>
                    <td scope="row" class="border"><input type="password" name="password"
        ...
        <div class="col-12 text-center mt-5">
            <button class="btn add-btn" type="submit">Add Manager</button>
        </div>
