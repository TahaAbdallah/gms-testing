...
@section('dashboard-title','Add Design Service')
...
@section('content')
        ...
        <div class="under-burger-btn-cont mr-4 ml-4">
            <div class="container-fluid row m-0 p-0 align-items-center">
                ...
                <div class="col-6 col-md-4 text-right">
                    <a name="" id="" class="btn add-btn" href="{{route('designServices')}}" role="button">Show All Design Services</a>
                </div>
            </div>
        </div>
        ...
        <form action="{{route('designService.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="table-responsive ml-4 mr-4">
            ...
            <div class="col-12 text-center mt-5">
                <button class="btn add-btn" type="submit">Add Design Service</button>
            </div>
