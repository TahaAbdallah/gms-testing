...
@section('dashboard-title','Add Development Service')
...
@section('content')
        ...
        <form action="{{route('developmentService.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="table-responsive mr-4 ml-4">
            ...
            <div class="col-12 text-center mt-5">
                <button class="btn add-btn" type="submit">Add Development Service</button>
            </div>
