...
<body>
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div><img class="img-fluid" src="{{URL::asset('images/GMS - LOGO-1@2x.png')}}"></div>

      <h1 class="mt-2">Welcome Our Employees</h1>

      <form class="form" method="POST" action="{{ route('empSignInProccess') }}">
        @csrf
      ...
      <div class="row justify-content-center align-items-center">
        ...
        <a href="http://gulfmediasolution.com" target="_blank" style="z-index: 999"><img class="img-fluid p-1"
            src="{{URL::asset('images/GMS - LOGO-1@2x.png')}}" width="60px"></a>
      </div>
