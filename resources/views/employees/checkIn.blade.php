  ...
  <div class="wrapper">
    ...
    <div class="barcode-cont">
      ...
      <div class="barcode-sm-cont">
        ...
        <h3 class="logged-from-desktop">Please Login from a Mobile Device.</h3>

        <form class="check-in-form" method="POST" action="{{ route('createCheckIn') }}" enctype="multipart/form-data">
          @csrf
          ...
          color: white">
            ...
            <a>Please Take A Pic Of Yourself.</a>
